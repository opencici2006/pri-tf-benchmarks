...
tf.app.flags.DEFINE_integer('inter_op', 1,
                           """Inter Op Parallelism Threads.""")
tf.app.flags.DEFINE_integer('intra_op', 80,
...
def run_datalayer():
	with tf.Graph().as_default():  
		...
		data_file = ["/home/shengfu/nervana/imagenet-data/train-00120-of-00128", 
                  	 "/home/shengfu/nervana/imagenet-data/train-00121-of-00128",
                  	 "/home/shengfu/nervana/imagenet-data/train-00122-of-00128", 
                  	 "/home/shengfu/nervana/imagenet-data/train-00123-of-00128", 
                  	 "/home/shengfu/nervana/imagenet-data/train-00124-of-00128", 
                  	 "/home/shengfu/nervana/imagenet-data/train-00125-of-00128", 
                  	 "/home/shengfu/nervana/imagenet-data/train-00126-of-00128",                   
                  	 "/home/shengfu/nervana/imagenet-data/train-00127-of-00128"
		            ]
		dataset = tf.contrib.data.TFRecordDataset(data_file)
		dataset = dataset.map(parse_example_proto, num_threads=1, output_buffer_size=4*FLAGS.batch_size)
		dataset = dataset.map(preprocess, num_threads=1, output_buffer_size=4*FLAGS.batch_size)
